...
import com.tweetapp.TweetApplication.User.Tweet;
	...
	public void beforeLogin() {
		...
		do {
			...
			case 1:
				...
				userService.registerUser(new User(firstName, lastName, gender, dob, email, password));
				break;
	...
	public void afterLogin(String email, String password) {
		...
		do {
			...
			case 1:
				...
				tweetService.postTweet(new Tweet(tweet, email));
				break;
			case 2:
